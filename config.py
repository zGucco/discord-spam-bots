...
userToken = ['dylangodoyleonel588@gmail.com', 'dylanpro288'] # User Tokens here. example 'token','token' | 'email:pass', 'token'
DiscordChannel = '965994870625931274' # Channel ID,
SpamSpeed = 0.1 # Changes how fast the messages are posted. (Anything under 0.7 tends to break it (┛✧Д✧))┛彡┻━┻ )
